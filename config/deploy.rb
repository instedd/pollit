...
namespace :foreman do
  ...
  task :export, :roles => :app do
    ...
    run "cd #{current_path} && rvmsudo bundle exec foreman export upstart /etc/init -l #{shared_path}/log -f #{current_path}/Procfile -a #{application} -u #{user} --concurrency=\"delayed=1\""
  end
